...
<body>
	...
	# code...
			...
			echo "<tr><td>Input  Power 1 (dBm)</td><td>" . $input1_rrx[$i] . "</td></tr>";
			echo "<tr><td>Input Power 2 (dBm)</td><td>" . $input2_rrx[$i] . "</td></tr>";
			echo "<tr><td>Input Power 3 (dBm)</td><td>" . $input3_rrx[$i] . "</td></tr>";
			echo "<tr><td>Input Power 4 (dBm)</td><td>" . $input4_rrx[$i] . "</td></tr>";
			echo "<tr><td>Status 1</td><td>" . rrxstatus($status1_rrx[$i]) . "</td></tr>";
			echo "<tr><td>Status 2</td><td>" . rrxstatus($status2_rrx[$i]) . "</td></tr>";
			echo "<tr><td>Status 3</td><td>" . rrxstatus($status3_rrx[$i]) . "</td></tr>";
			echo "<tr><td>Status 4</td><td>" . rrxstatus($status4_rrx[$i]) . "</td></tr>";
			echo "</table>";
			echo "<br>";
		}
	...
	# code...
			...
			echo "<tr><td>Serial Number</td><td>" . $sn_ftx[$i] . "</td></tr>";
			echo "<tr><td>RF Input Power (dBm)</td><td>" . $rfinputpower_ftx[$i] . "</td></tr>";
			echo "<tr><td>Laser Bias Current (mA)</td><td>" . $laserbiascurrent_ftx[$i] . "</td></tr>";
			echo "<tr><td>Output Power (dBm)</td><td>" . $outputpower_ftx[$i] . "</td></tr>";
			echo "<tr><td>Laser Type</td><td>" . $lasertype_ftx[$i] . "</td></tr>";
			echo "<tr><td>Wave Length (nm)</td><td>" . $wavelength_ftx[$i] . "</td></tr>";
			echo "<tr><td>THC Current (mA)</td><td>" . $thccurrent_ftx[$i] . "</td></tr>";
			echo "</table>";
			echo "<br>";
		}
