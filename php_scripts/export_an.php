...
$path = "'" . getcwd()."\DataFolder\data_ack.csv" . "'";
...
if(file_exists("DataFolder\data_ack.csv")){
  
  $myfile = fopen("DataFolder\data_ack.csv", "a+") or die("Unable to open file!");
...
function file_downloading($file="DataFolder\data_ack.csv"){
  if(file_exists($file)) {
