...
TO 'C:/rapidnms/data_alarm.csv' With CSV HEADER;
";
$result = pg_query($query) or die('Query failed: ' . pg_last_error());

if(file_exists("C:/rapidnms/data_alarm.csv")){

  $myfile = fopen("C:/rapidnms/data_alarm.csv", "a+") or die("Unable to open file!");
...
function file_downloading($file="C:/rapidnms/data_alarm.csv"){
  if(file_exists($file)) {
